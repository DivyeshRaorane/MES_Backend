...
\restrict oY3zEyGWv817eqAt1KGhzKNzCHtBGRFnnshvo1oXm81h1f0qrFshuQ78CbRCihe
...
CREATE TABLE public.bobbin_entries (
    ...
    pt_strain integer,
    CONSTRAINT bobbin_entries_dispatch_status_check CHECK (((dispatch_status)::text = ANY ((ARRAY['NO'::character varying, 'YES'::character varying, 'COLOR'::character varying, 'REW'::character varying])::text[])))
);
...
ALTER TABLE ONLY public.pt_machine_logs
    ADD CONSTRAINT pt_machine_logs_pkey PRIMARY KEY (spool_code_tu);
...
\unrestrict oY3zEyGWv817eqAt1KGhzKNzCHtBGRFnnshvo1oXm81h1f0qrFshuQ78CbRCihe
